...
\newcommand{\doctype}{\codeFormation} % changer ici selon besoin
...
%Concours Banque de France

\newcommand{\doctype@colors@D23}{%
    \definecolor{primarycolor}{HTML}{007681}
    \definecolor{secondarycolor}{HTML}{E5F1F2}
    \definecolor{background1}{HTML}{AE2573}
    \definecolor{background2}{HTML}{F7E8F1}
}

%Actualité

\newcommand{\doctype@colors@}{%
