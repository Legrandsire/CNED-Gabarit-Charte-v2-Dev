...
% Auteur(s)
\noindent
\underline{\textbf{\fontsize{10}{12}\selectfont Auteur(s)}}\\[0.4em]
\makeatletter
...
% Sources : liste unique alimentée par \credits (images, tableaux...)
\noindent
\underline{\textbf{\fontsize{10}{12}\selectfont Source(s)}}\\[0.4em]

{\fontsize{7.5}{9}\selectfont
Tout contenu (image, tableau...) non mentionné dans la liste suivante est la propriété du Cned.

\vspace{0.3em}

\begin{itemize}[dash][primary]
  \mescredits
\end{itemize}
\par}
