...
\draw[dashed, line width=0.5pt, color=secondarycolor]
  (0,0) -- (\linewidth,0);
\end{tikzpicture} %% Trait au dessus des crédits


\vspace{1em} %% Distance entre le trait et le mot crédit

\hspace{-5pt} \hyperlink{target}{\fontsize{16}{18} \selectfont \textbf{Crédits}}
...
\noindent\textcolor{secondarycolor}{\rule{\linewidth}{0.1pt}}
\vspace{-0.5em}
